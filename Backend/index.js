  ...
  fetch(url, { method: "GET" })
    ...
    .then((res) => {
      ...
      for (var i = 0; i < res.length; i++) {
        ...
        cell8.innerHTML = item.camp_preference;
        cell9.innerHTML = "<button class='btn btn-primary' onclick='item_dele(" + item.id + ")'>D</button>"
...
function btn_add_click() {
  const data = {
    "place": document.getElementById("staticBackdropLabel").value,
